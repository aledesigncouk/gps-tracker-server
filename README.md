...
Backend of the Nautilus trips tracker, an application that can display tracks generated by GPS trackers. It enable a simple interface to upload .csv data into a MySQL DB and provide some endpoints for the Frontend.
